  ...
  return [
    {
      ...
      items: [
        ...
        { id: 'notes', label: 'Notes', badge: 'NEW', iconSet: 'ion', iconName: 'document-text-outline', accent: '#F9A825', route: 'Notes' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'weather', label: 'Weather', badge: 'NEW', iconSet: 'ion', iconName: 'partly-sunny-outline', accent: '#29B6F6', route: 'Weather' },
      ],
    },
  ];
}
    ...
    >
      {item.badge ? (
        <View style={styles.badgeAbs}>
          <SoftBadge label={item.badge} size="tile" />
        </View>
      ) : null}
      <View
        style={[
