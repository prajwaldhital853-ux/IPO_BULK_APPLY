...
DEFAULT_ABOUT = {
    ...
    'whoWeAre': (
        ...
        'market data, and access research tools ΓÇö all from one mobile app.'
    ),
    'offerings': [
...
DEFAULT_TERMS = {
    ...
    'sections': [
        ...
        },
        {
            ...
            'body': (
                'You agree not to misuse the app, attempt to access other usersΓÇÖ '
...
DEFAULT_PRIVACY = {
    ...
    'sections': [
        ...
        },
        {
            ...
            'body': (
                'We use your data only to run the features you use ΓÇö logging into MeroShare, '
        ...
        },
        {
            ...
            'body': (
                ...
                'uninstall the app. You can delete your profile at any time from Profile ΓåÆ '
        ...
        },
        {
            'heading': '8. Contact',
            'body': (
                'For any privacy question, contact us from Profile ΓåÆ Connect With Us '
                '(email or WhatsApp).'
            ),
        },
    ],
